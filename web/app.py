...
_UNIT_DIFF_DEFAULT = {
    ...
    "NB701107":    (30,  "청수식품 맑은물 냉면육수 300g/동치미맛 (1BOX=30EA)", "동원홈푸드", "166941",     "NB701107"),
    "166941":      (30,  "청수식품 맑은물 냉면육수 300g/동치미맛 (1BOX=30EA)", "동원홈푸드", "166941",     "NB701107"),
    "NB706070":    (30,  "영미 동치미 냉면육수 310g (1BOX=30EA)",          "웰스토리",  "1000781659", "NB706070"),
    "1000781659":  (30,  "영미 동치미 냉면육수 310g (1BOX=30EA)",          "웰스토리",  "1000781659", "NB706070"),
    "NE101062":    (6,   "삼원 튀김스프링 회오리감자 700g/냉동 (1BOX=6PAK)", "아워홈",  "26610252",   "NE101062"),
    "26610252":    (6,   "삼원 튀김스프링 회오리감자 700g/냉동 (1BOX=6PAK)", "아워홈",  "26610252",   "NE101062"),
    "NE101075":    (6,   "화영푸드 회오리감자 800g/냉동 (1BOX=6PAK)",      "프레시웨이", "355885",    "NE101075"),
    "355885":      (6,   "화영푸드 회오리감자 800g/냉동 (1BOX=6PAK)",      "프레시웨이", "355885",    "NE101075"),
    "NH101013":    (10,  "푸드림 미니바 정백슬림스틱슈가(5g*100ea) (1BOX=10EA)", "웰스토리", "1000168270", "NH101013"),
    "1000168270":  (10,  "푸드림 미니바 정백슬림스틱슈가(5g*100ea) (1BOX=10EA)", "웰스토리", "1000168270", "NH101013"),
    "NH512021":    (10,  "식예원 가쓰오맛 후리가께 50g (1PAC=10EA)",       "웰스토리",  "1000749953", "NH512021"),
    "1000749953":  (10,  "식예원 가쓰오맛 후리가께 50g (1PAC=10EA)",       "웰스토리",  "1000749953", "NH512021"),
    "NH610019":    (20,  "신진 신화당 50g (1PAK=20EA)",                    "동원홈푸드", "101981",    "NH610019"),
    "101981":      (20,  "신진 신화당 50g (1PAK=20EA)",                    "동원홈푸드", "101981",    "NH610019"),
    "NI307040":    (24,  "진로 하이트제로 350ml/무알콜 (1BOX=24EA)",       "동원홈푸드", "177494",    "NI307040"),
    "177494":      (24,  "진로 하이트제로 350ml/무알콜 (1BOX=24EA)",       "동원홈푸드", "177494",    "NI307040"),
    "NI309007":    (12,  "랭거스 망고쥬스 449ml (1BOX=12EA)",              "현대 그린푸드", "1373569", "NI309007"),
    "1373569":     (12,  "랭거스 망고쥬스 449ml (1BOX=12EA)",              "현대 그린푸드", "1373569", "NI309007"),
    "NL102043":    (2,   "유진 카사바칩 1.2kg (1BOX=2EA)",                 "현대 그린푸드", "1467838", "NL102043"),
    "1467838":     (2,   "유진 카사바칩 1.2kg (1BOX=2EA)",                 "현대 그린푸드", "1467838", "NL102043"),
}
        ...
        try:
            ...
            for k, v in data.items():
                ...
                if len(t) > 2 and k in _UNIT_DIFF_DEFAULT:
                    d = _UNIT_DIFF_DEFAULT[k]
                    # 벤더사가 비어있거나, 과거 제조사명이 잘못 들어간 경우 실제 급식사로 교정
                    vendor = d[2] if (not t[2] or t[2] in _OLD_MANUFACTURER_VENDORS) else t[2]
                    # 급식코드가 비어있으면 최신 기본값으로 채움
                    급식코드 = t[3] if (len(t) > 3 and t[3]) else d[3]
                    t = (t[0], t[1], vendor, 급식코드, t[4] if len(t) > 4 else d[4])
                result[k] = t
            # 급식코드가 새로 채워졌는데 아직 해당 키로 등록 안 된 경우 추가
            for k, t in list(result.items()):
                if len(t) > 3 and t[3] and t[3] not in result:
                    result[t[3]] = t
            return result
        except: pass
